...
<head>
    ...
    <title>Hotel Batana - Deluxe Sea Family Soba</title>
...
<body>
    ...
    <h1 class="pt-5 mb-4 title-text">DELUXE SEA FAMILY SOBA<div class="osobe">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="custom-radius d-block w-100" src="assets/photos/deluxeseafamilyslike/deluxeseafamily1.webp" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="custom-radius d-block w-100" src="assets/photos/deluxeseafamilyslike/deluxeseafamily2.webp." alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="custom-radius d-block w-100" src="assets/photos/deluxeseafamilyslike/deluxeseafamily3.webp" alt="Third slide">
                </div>
            </div>
        ...
        <div class="tekst-box w-100">
            ...
            <div class="tabela row mx-n4">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 px-4">
                    <div class="d-flex align-items-center">
                        <span class="check-icon">&#10003;</span>
                        <p class="ml-2 mb-0">Maksimalno četiri osobe</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 mb-4 px-4">
                    <div class="d-flex align-items-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 px-4">
                    <div class="d-flex align-items-center">
                        <span class="check-icon">&#10003;</span>
                        <p class="ml-2 mb-0">Dva balkona, svaki s dva stolca i stolom</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 mb-4 px-4">
                    <div class="d-flex align-items-center">
                        <span class="check-icon">&#10003;</span>
                        <p class="ml-2 mb-0">Dvije kupaonice s kadom, tušem s efektom kiše</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4 mb-4 px-4">
                    <div class="d-flex align-items-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 px-4">
                    <div class="d-flex align-items-center">
                        <span class="check-icon">&#10003;</span>
                        <p class="ml-2 mb-0">Dvije dvokrevetne sobe</p>
                    </div>
                </div>
            </div>
        </div>
